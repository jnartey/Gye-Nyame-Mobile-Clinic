...
class PageContentsController extends AppController {
	...
	public function admin_add($id = null) {
		...
		$project_category = $this->PageContent->find('list', array('conditions'=>array('PageContent.category'=>8, 'PageContent.overview'=>0), 'fields'=>array('PageContent.id', 'PageContent.title')));
